              ...
              <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="program-item nursery">
                  <div class="program-header">
                    ...
                    <span class="program-type bg-success">Nursery</span>
                  </div>
              ...
              <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="program-item primary">
                  <div class="program-header">
                    ...
                    <span class="program-type bg-success">Primary 1–6</span>
                  </div>
                  <div class="program-body">
              ...
              <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="program-item jss">
                  <div class="program-header">
                    ...
                    <span class="program-type bg-success">JSS 1–3</span>
                  </div>
                  <div class="program-body">
              ...
              <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="program-item sss">
                  <div class="program-header">
                    ...
                    <span class="program-type bg-success">SS 1–3</span>
                  </div>
                  <div class="program-body">
