...
<head>
    ...
    <meta name="description" content="EduPack Documentaation.">
    <title>Edupack Documentation</title>
        ...
        <div class="menu">
            <ul class="list">
                <?php if ($_SESSION['role'] == 'Superuser') { ?>
                    <li class="open"><a href="../backend/superdashboard.php"><i class="zmdi zmdi-home"></i><span>Back to Dashboard</span></a></li>
                <?php } elseif ($_SESSION['role'] == 'Administrator') { ?>
                    <li class="open"><a href="../backend/dashboard.php"><i class="zmdi zmdi-home"></i><span>Back to Dashboard</span></a></li>
                <?php } elseif ($_SESSION['role'] == 'Teacher') { ?>
                    <li class="open"><a href="../backend/dashboard.php"><i class="zmdi zmdi-home"></i><span>Back to Dashboard</span></a></li>
                <?php } elseif ($_SESSION['role'] == 'Admission') { ?>
                    <li class="open"><a href="../backend/dashboard.php"><i class="zmdi zmdi-home"></i><span>Back to Dashboard</span></a></li>
                <?php } elseif ($_SESSION['role'] == 'Tuckshop') { ?>
                    <li class="open"><a href="../backend/tuckdashboard.php"><i class="zmdi zmdi-home"></i><span>Back to Dashboard</span></a></li>
                <?php } ?>
                ...
                <li class="open"><a href="#payment_history"><i class="zmdi zmdi-receipt"></i><span>Payment History</span></a></li>
                <li class="open"><a href="#transaction_history"><i class="zmdi zmdi-format-list-bulleted"></i><span>Transaction History</span></a></li>
                <li class="open"><a href="#student_fee_breakdown"><i class="zmdi zmdi-format-list-numbered"></i><span>Student Fee Breakdown</span></a></li>
                <li class="open"><a href="#print_student_transaction"><i class="zmdi zmdi-print"></i><span>Print Student Transaction</span></a></li>
                <li class="open"><a href="#print_receipt"><i class="zmdi zmdi-print"></i><span>Print Receipt</span></a></li>
                <li class="open"><a href="#tuckshop_payment_history"><i class="zmdi zmdi-money-box"></i><span>Tuckshop Payment History</span></a></li>
                <li class="open"><a href="#admin_tuckshop_payment_history"><i class="zmdi zmdi-money-box"></i><span>Admin Tuckshop Payment History</span></a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2>EDUPACK DOCUMENTATION</h2>
                        <p class="lead mt-2">Welcome to the Edupack Documentation. This guide provides comprehensive instructions on how to effectively use and manage the various features within the Edupack School Management System. Whether you are an administrator or teacher, this documentation will help you navigate the platform and utilize its functionalities to enhance the educational experience.</p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseEnroll" class="accordion-collapse collapse" aria-labelledby="headingEnroll" data-bs-parent="#studentManagementAccordion">
                                                    <div class="accordion-body">
                                                        <p>This feature is designed for school administrators or admission officers to seamlessly add new students to the Edupack system. Think of it as the digital registration desk for new students, ensuring all their initial information is captured accurately from the start of their academic journey.</p>
                                                        <ol>
                                                            ...
                                                            <li><strong>Submit the Enrollment Form:</strong>
                                                                <ul>
                                                                    ...
                                                                    <li>Upon successful submission, the student's record will be officially saved in the Edupack database. They are now a registered student and can be managed through other features like attendance, results, and parent communication.</li>
                                                                </ul>
                                                            </li>
                                                        </ol>
                                                    </div>
                                    ...
                                    <div class="row">
                                                                            ...
                                                                            <ol>
                                                                                ...
                                                                                <li><strong>Save the Attendance Record:</strong>
                                                                                    <ul>
                                                                                        ...
                                                                                        <li>This action saves the attendance record for that specific class, arm, and date into the Edupack database.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                                ...
                                                                <div id="collapseUploadResults" class="accordion-collapse collapse" aria-labelledby="headingUploadResults" data-bs-parent="#resultsManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="upload_results">
                                                                            <p>The "Upload Results" feature is designed for teachers to submit student academic performance data into the Edupack system in bulk. This is a critical step in the academic cycle, ensuring that grades and scores are accurately recorded and made available for reporting and student profiles.</p>
                                                                            <ol>
                                                                                ...
                                                                                <li><strong>Prepare Your Result Data (Using a Template):</strong>
                                                                                    <ul>
                                                                                        <li>Edupack typically requires result data to be in a specific format, often provided via an Excel or CSV template.</li>
                                                                            ...
                                                                            <ol>
                                                                                ...
                                                                                <li><strong>Confirm and Execute Deletion:</strong>
                                                                                    <ul>
                                                                                        ...
                                                                                        <li><strong>Warning:</strong> Once confirmed, the selected student results will be permanently removed from the Edupack database. Ensure you have any necessary backups or approvals before proceeding.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                                ...
                                                                <div id="collapseRevokeResults" class="accordion-collapse collapse" aria-labelledby="headingRevokeResults" data-bs-parent="#resultsManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="revoke_results">
                                                                            <p>The "Revoke Student Results" feature is a critical administrative function, typically restricted to Superusers or Administrators, that allows for the reversal of approved student results. This action is usually taken in cases of data entry errors, policy changes, or when results need to be re-evaluated. It's a powerful tool that should be used with extreme caution due to its impact on official academic records.</p>
                                                                            <ol>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="accordion" id="bursaryManagementAccordion">
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingBursaryDashboard">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBursaryDashboard" aria-expanded="false" aria-controls="collapseBursaryDashboard">
                                                                        How to View Bursary Dashboard
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseBursaryDashboard" class="accordion-collapse collapse" aria-labelledby="headingBursaryDashboard" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="bursary_dashboard">
                                                                            <p>The "Bursary Dashboard" provides a comprehensive overview of the school's financial status related to student fees, payments, and outstanding balances. This dashboard is designed for bursary staff and administrators to quickly monitor financial health, track payment trends, and identify students with pending fees. It serves as a central hub for all bursary-related insights.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Bursary Dashboard Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Dashboard</strong>.</li>
                                                                                        <li>This will take you to the Bursary Dashboard page, which displays key financial metrics.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Review Key Financial Metrics:</strong>
                                                                                    <ul>
                                                                                        <li>On the Bursary Dashboard page, you will find various widgets and charts displaying important financial metrics, including:
                                                                                            <ul>
                                                                                                <li><strong>Total Expected Fees:</strong> The total amount of fees expected from all students.</li>
                                                                                                <li><strong>Total Fees Paid:</strong> The cumulative amount of fees already paid by students.</li>
                                                                                                <li><strong>Outstanding Balance:</strong> The total amount of fees yet to be paid.</li>
                                                                                                <li><strong>Recent Transactions:</strong> A summary of the latest payment activities.</li>
                                                                                                <li><strong>Payment Trends:</strong> Visualizations showing payment patterns over time.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This dashboard offers real-time insights into the school's financial standing, enabling bursary staff to make informed decisions, manage cash flow, and proactively address payment issues.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="collapseFeesManagement" class="accordion-collapse collapse" aria-labelledby="headingFeesManagement" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="fees_management">
                                                                            <p>The "Fees Management" feature is a comprehensive tool for administrators and bursary staff to define, configure, and maintain the school's fee structures. This includes setting up different fee types, assigning fees to specific classes or student categories, and managing payment due dates. Effective fees management ensures transparency, accuracy, and fairness in the school's financial operations.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Fees Management Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Fees Management</strong>.</li>
                                                                                        <li>This will take you to the Fees Management page, which is the central interface for all fee-related configurations.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Define Fee Types and Amounts:</strong>
                                                                                    <ul>
                                                                                        <li>On the Fees Management page, you can create new fee categories (e.g., "Tuition Fee," "Uniform Fee," "Exam Fee").</li>
                                                                                        <li>For each fee type, specify the amount and any applicable terms (e.g., per term, per session).</li>
                                                                                ...
                                                                                <li><strong>Update or Delete Fee Structures:</strong>
                                                                                    <ul>
                                                                                        <li>The page also allows you to modify existing fee amounts, change descriptions, or remove outdated fee categories.</li>
                                                                                        <li><strong>Warning:</strong> Exercise caution when deleting fee structures, as it can impact historical financial records.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Transparency:</strong> Provides clear and detailed fee structures for all stakeholders.</li>
                                                                                        <li><strong>Accuracy:</strong> Ensures consistent application of fees across the student body.</li>
                                                                                        <li><strong>Flexibility:</strong> Allows for easy adjustment of fees based on school policies or economic changes.</li>
                                                                                        <li><strong>Efficiency:</strong> Streamlines the process of setting up and managing school fees.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingStudentPayment">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseStudentPayment" aria-expanded="false" aria-controls="collapseStudentPayment">
                                                                        How to Record Student Payments
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseStudentPayment" class="accordion-collapse collapse" aria-labelledby="headingStudentPayment" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="student_payment">
                                                                            <p>The "Student Payment" feature is designed for bursary staff to accurately record and process fee payments made by students. This ensures that all financial transactions are properly logged, student accounts are updated in real-time, and a clear audit trail is maintained. It's a critical component for managing the school's incoming revenue.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Student Payment Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Student Payment</strong>.</li>
                                                                                        <li>This will take you to the Student Payment page, which is the interface for recording payments.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Search for Student and Enter Payment Details:</strong>
                                                                                    <ul>
                                                                                        <li>On the Student Payment page, search for the student by their ID or name.</li>
                                                                                        <li>Once the student is selected, their outstanding fees and payment history will be displayed.</li>
                                                                                        <li>Enter the payment amount, method (e.g., cash, bank transfer), and any relevant transaction reference.</li>
                                                                                        <li><strong>Important for Users:</strong> Double-check the student's identity and the payment amount before processing to avoid errors.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Process and Confirm Payment:</strong>
                                                                                    <ul>
                                                                                        <li>After entering all details, click the "Process Payment" or "Submit" button.</li>
                                                                                        <li>The system will update the student's account, reduce their outstanding balance, and generate a payment record.</li>
                                                                                        <li><strong>Confirmation:</strong> A success message and a transaction ID will be displayed upon successful payment.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Accuracy:</strong> Ensures all payments are correctly attributed to student accounts.</li>
                                                                                        <li><strong>Real-time Updates:</strong> Student balances are immediately updated, providing current financial status.</li>
                                                                                        <li><strong>Audit Trail:</strong> Creates a detailed record of every payment for reconciliation and reporting.</li>
                                                                                        <li><strong>Efficiency:</strong> Streamlines the payment recording process for bursary staff.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingParentPayment">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseParentPayment" aria-expanded="false" aria-controls="collapseParentPayment">
                                                                        How Parents Make Payments
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseParentPayment" class="accordion-collapse collapse" aria-labelledby="headingParentPayment" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="parent_payment">
                                                                            <p>The "Parent Payment" feature provides a secure and convenient online portal for parents to make fee payments for their children. This self-service option streamlines the payment process, reduces administrative burden, and offers parents flexibility to pay anytime, anywhere. It integrates directly with the school's financial system to update student accounts automatically.</p>
                                                                            <ol>
                                                                                ...
                                                                                <li><strong>Select Student and View Outstanding Fees:</strong>
                                                                                    <ul>
                                                                                        <li>On the Parent Payment page, parents will see a list of their enrolled children and their respective outstanding fees.</li>
                                                                                        <li>They can select the child for whom they wish to make a payment.</li>
                                                                                        <li><strong>Important for Users:</strong> Parents should verify the correct child and the amount due before proceeding.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Choose Payment Method and Complete Transaction:</strong>
                                                                                    <ul>
                                                                                        <li>Parents will be presented with various online payment options (e.g., credit/debit card, bank transfer, mobile money).</li>
                                                                                        <li>They will enter the payment amount and their payment details securely.</li>
                                                                                        <li>Upon successful transaction, the system will automatically update the student's fee status.</li>
                                                                                        <li><strong>Confirmation:</strong> A digital receipt and confirmation message will be sent to the parent's registered email address and displayed on the screen.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Convenience:</strong> Parents can pay fees 24/7 from any location.</li>
                                                                                        <li><strong>Efficiency:</strong> Automates payment processing and updates student accounts instantly.</li>
                                                                                        <li><strong>Transparency:</strong> Provides parents with clear visibility of their child's fee status and payment history.</li>
                                                                                        <li><strong>Security:</strong> Ensures secure handling of financial transactions through integrated payment gateways.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingPaymentHistory">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePaymentHistory" aria-expanded="false" aria-controls="collapsePaymentHistory">
                                                                        How to View Payment History
                                                                    </button>
                                                                </h2>
                                                                <div id="collapsePaymentHistory" class="accordion-collapse collapse" aria-labelledby="headingPaymentHistory" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="payment_history">
                                                                            <p>The "Payment History" feature provides a detailed record of all fee payments made by students. This comprehensive log is essential for financial reconciliation, auditing, resolving payment queries, and tracking individual student payment patterns. It offers a transparent and searchable record of all incoming fee transactions.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Payment History Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Payment History</strong>.</li>
                                                                                        <li>This will take you to the Payment History page, which is the central repository for all payment records.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Review the List of All Payments:</strong>
                                                                                    <ul>
                                                                                        <li>On the Payment History page, you will see a chronological list of all completed payment transactions. Each entry typically includes:
                                                                                            <ul>
                                                                                                <li><strong>Transaction ID:</strong> The unique transaction identifier.</li>
                                                                                                <li><strong>Student ID:</strong> The ID of the student for whom the payment was made.</li>
                                                                                                <li><strong>Student Name:</strong> The name of the student.</li>
                                                                                                <li><strong>Amount Paid:</strong> The total amount of the payment.</li>
                                                                                                <li><strong>Payment Method:</strong> How the payment was made (e.g., cash, bank transfer).</li>
                                                                                                <li><strong>Date:</strong> Date and time of the transaction.</li>
                                                                                                <li><strong>Recorded By:</strong> The staff member who processed the payment (if applicable).</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This detailed list provides a clear overview of all payment activities, making it easy to track individual transactions and reconcile accounts.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Filter and Search Payments (Optional):</strong>
                                                                                    <ul>
                                                                                        <li>You can typically filter payments by student name, ID, date range, or payment method to quickly find specific transactions.</li>
                                                                                        <li><strong>Tip for Users:</strong> Use these filters to efficiently locate specific payment records when resolving queries or preparing reports.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Financial Accountability:</strong> Provides a complete audit trail for all payments, simplifying financial reporting and reconciliation.</li>
                                                                                        <li><strong>Customer Service:</strong> Quickly resolve student or parent queries regarding payments.</li>
                                                                                        <li><strong>Payment Analysis:</strong> Offers data for understanding payment patterns and overall revenue performance.</li>
                                                                                        <li><strong>Error Correction:</strong> Helps in identifying any discrepancies in payment records.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingTransactionHistory">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTransactionHistory" aria-expanded="false" aria-controls="collapseTransactionHistory">
                                                                        How to View Transaction History
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseTransactionHistory" class="accordion-collapse collapse" aria-labelledby="headingTransactionHistory" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="transaction_history">
                                                                            <p>The "Transaction History" feature provides a comprehensive log of all financial movements related to student accounts, including both payments received and any adjustments made. This detailed record is crucial for maintaining accurate financial statements, auditing, and providing transparent financial information to parents and guardians. It offers a complete overview of a student's financial interactions with the school.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Transaction History Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Transaction History</strong>.</li>
                                                                                        <li>This will take you to the Transaction History page, which is the central repository for all financial records.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Review Detailed Transaction Records:</strong>
                                                                                    <ul>
                                                                                        <li>On the Transaction History page, you will see a chronological list of all financial transactions. Each entry typically includes:
                                                                                            <ul>
                                                                                                <li><strong>Transaction ID:</strong> A unique identifier for each transaction.</li>
                                                                                                <li><strong>Student ID:</strong> The ID of the student associated with the transaction.</li>
                                                                                                <li><strong>Student Name:</strong> The name of the student.</li>
                                                                                                <li><strong>Description:</strong> Details about the transaction (e.g., "Tuition Fee Payment," "Late Fee Applied").</li>
                                                                                                <li><strong>Amount:</strong> The monetary value of the transaction (indicating credit or debit).</li>
                                                                                                <li><strong>Date:</strong> Date and time of the transaction.</li>
                                                                                                <li><strong>Balance Impact:</strong> How the transaction affected the student's overall balance.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This detailed log provides a complete financial picture for each student, making it easy to track all monetary interactions and resolve any discrepancies.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Filter and Search Transactions (Optional):</strong>
                                                                                    <ul>
                                                                                        <li>You can typically filter transactions by student name, ID, date range, or transaction type to quickly find specific records.</li>
                                                                                        <li><strong>Tip for Users:</strong> Use these filters to efficiently locate specific transaction records when resolving queries or preparing financial reports.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Comprehensive Overview:</strong> Provides a complete financial history for each student.</li>
                                                                                        <li><strong>Audit Readiness:</strong> Ensures all financial movements are recorded and traceable.</li>
                                                                                        <li><strong>Transparency:</strong> Offers clear financial statements for internal review and external reporting.</li>
                                                                                        <li><strong>Dispute Resolution:</strong> Facilitates quick resolution of any financial queries from parents or students.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingStudentFeeBreakdown">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseStudentFeeBreakdown" aria-expanded="false" aria-controls="collapseStudentFeeBreakdown">
                                                                        How to View Student Fee Breakdown
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseStudentFeeBreakdown" class="accordion-collapse collapse" aria-labelledby="headingStudentFeeBreakdown" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="student_fee_breakdown">
                                                                            <p>The "Student Fee Breakdown" feature allows bursary staff and parents to view a detailed itemization of all fees applicable to a specific student. This provides complete transparency regarding what each student is being charged for, including tuition, levies, and other charges, along with their payment status for each component. It helps in understanding the total financial obligation and tracking payments against specific fee items.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Student Fee Breakdown Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Student Fee Breakdown</strong>.</li>
                                                                                        <li>This will take you to the Student Fee Breakdown page, which is the interface for viewing detailed fee structures.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Search for Student and View Breakdown:</strong>
                                                                                    <ul>
                                                                                        <li>On the Student Fee Breakdown page, search for the student by their ID or name.</li>
                                                                                        <li>Once the student is selected, the system will display a detailed breakdown of their fees, typically including:
                                                                                            <ul>
                                                                                                <li><strong>Fee Item:</strong> The specific charge (e.g., "Tuition," "Uniform," "Technology Fee").</li>
                                                                                                <li><strong>Amount Due:</strong> The original amount for that fee item.</li>
                                                                                                <li><strong>Amount Paid:</strong> How much has been paid towards that specific item.</li>
                                                                                                <li><strong>Outstanding:</strong> The remaining balance for that fee item.</li>
                                                                                                <li><strong>Total Outstanding:</strong> The cumulative outstanding balance across all fee items.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This detailed breakdown helps parents understand exactly what they are paying for and allows bursary staff to manage individual fee components more effectively.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Transparency:</strong> Provides a clear, itemized list of all fees for a student.</li>
                                                                                        <li><strong>Clarity:</strong> Helps parents and staff understand the composition of total fees.</li>
                                                                                        <li><strong>Accountability:</strong> Tracks payments against specific fee items, ensuring accurate financial records.</li>
                                                                                        <li><strong>Dispute Resolution:</strong> Facilitates easy resolution of queries regarding specific charges.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingPrintStudentTransaction">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePrintStudentTransaction" aria-expanded="false" aria-controls="collapsePrintStudentTransaction">
                                                                        How to Print Student Transaction Report
                                                                    </button>
                                                                </h2>
                                                                <div id="collapsePrintStudentTransaction" class="accordion-collapse collapse" aria-labelledby="headingPrintStudentTransaction" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="print_student_transaction">
                                                                            <p>The "Print Student Transaction Report" feature allows bursary staff to generate a printable document detailing a student's complete financial transaction history. This report is invaluable for providing parents with official statements, for internal auditing, or for record-keeping purposes. It consolidates all payments, charges, and adjustments related to a student's account into a single, easy-to-read document.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Print Student Transaction Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Print Student Transaction</strong>.</li>
                                                                                        <li>This will take you to the Print Student Transactions page, which is designed for generating these reports.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Search for Student and Generate Report:</strong>
                                                                                    <ul>
                                                                                        <li>On the Print Student Transactions page, search for the student by their ID or name.</li>
                                                                                        <li>Once the student is selected, click the "Generate Report" or "Print" button.</li>
                                                                                        <li>The system will compile all relevant transactions and generate a printable PDF report. This report typically includes:
                                                                                            <ul>
                                                                                                <li>Student's personal details.</li>
                                                                                                <li>A chronological list of all payments, charges, and adjustments.</li>
                                                                                                <li>Opening and closing balances for a specified period.</li>
                                                                                                <li>Total amount paid and total outstanding.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This feature provides an official, comprehensive financial statement for any student, simplifying communication with parents and ensuring accurate record-keeping.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Official Documentation:</strong> Provides formal financial statements for students.</li>
                                                                                        <li><strong>Transparency:</strong> Offers a clear and verifiable record of all financial interactions.</li>
                                                                                        <li><strong>Audit Support:</strong> Essential for internal and external financial audits.</li>
                                                                                        <li><strong>Parent Communication:</strong> Facilitates easy sharing of financial information with parents.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingPrintReceipt">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePrintReceipt" aria-expanded="false" aria-controls="collapsePrintReceipt">
                                                                        How to Print Payment Receipt
                                                                    </button>
                                                                </h2>
                                                                <div id="collapsePrintReceipt" class="accordion-collapse collapse" aria-bs-labelledby="headingPrintReceipt" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="print_receipt">
                                                                            <p>The "Print Payment Receipt" feature allows bursary staff to generate and print official receipts for payments received. This provides parents and students with proof of payment, which is essential for their records and for resolving any future payment queries. It ensures that every financial transaction is properly acknowledged and documented.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Print Payment Receipt Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Print Receipt</strong>.</li>
                                                                                        <li>This will take you to the Print Receipt page, which is designed for generating payment receipts.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Search for Transaction and Print Receipt:</strong>
                                                                                    <ul>
                                                                                        <li>On the Print Receipt page, you will typically search for a payment transaction using a transaction ID or student ID.</li>
                                                                                        <li>Once the specific payment is located, click the "Print Receipt" button.</li>
                                                                                        <li>The system will generate a printable receipt document, which usually includes:
                                                                                            <ul>
                                                                                                <li>School name and logo.</li>
                                                                                                <li>Transaction ID and date.</li>
                                                                                                <li>Student's name and ID.</li>
                                                                                                <li>Amount paid and payment method.</li>
                                                                                                <li>Description of the payment (e.g., "Tuition Fee - First Term").</li>
                                                                                                <li>Bursar's signature line.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This feature ensures that official proof of payment is readily available, enhancing trust and accountability in financial dealings.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Proof of Payment:</strong> Provides official documentation for parents and students.</li>
                                                                                        <li><strong>Accountability:</strong> Ensures every payment is acknowledged and recorded.</li>
                                                                                        <li><strong>Dispute Resolution:</strong> Helps in resolving any payment-related discrepancies.</li>
                                                                                        <li><strong>Professionalism:</strong> Enhances the school's financial professionalism.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingTuckshopPaymentHistory">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTuckshopPaymentHistory" aria-expanded="false" aria-controls="collapseTuckshopPaymentHistory">
                                                                        How to View Tuckshop Payment History (Student View)
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseTuckshopPaymentHistory" class="accordion-collapse collapse" aria-labelledby="headingTuckshopPaymentHistory" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="tuckshop_payment_history">
                                                                            <p>The "Tuckshop Payment History" feature allows students and parents to view a detailed record of all funds added to a student's tuckshop account. This provides transparency regarding recharges and helps students and parents track their tuckshop spending. It's a crucial tool for managing tuckshop balances effectively.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Tuckshop Payment History Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the student/parent dashboard, go to <strong>Tuckshop > Payment History</strong>.</li>
                                                                                        <li>This will take you to the Tuckshop Payment History page, which displays a list of all recharges.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Review Recharge Records:</strong>
                                                                                    <ul>
                                                                                        <li>On the Tuckshop Payment History page, you will see a chronological list of all funds added to the student's account. Each entry typically includes:
                                                                                            <ul>
                                                                                                <li><strong>Transaction ID:</strong> Unique identifier for the recharge.</li>
                                                                                                <li><strong>Amount:</strong> The amount recharged.</li>
                                                                                                <li><strong>Date:</strong> Date and time of the recharge.</li>
                                                                                                <li><strong>Processed By:</strong> The staff member who processed the recharge.</li>
                                                                                            </ul>
                                                                                        </li>
                                                                                        <li><strong>Benefit for Users:</strong> This feature helps students and parents keep track of their tuckshop funds, ensuring they are aware of their balance and spending.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Transparency:</strong> Provides a clear record of all tuckshop recharges.</li>
                                                                                        <li><strong>Budgeting:</strong> Helps students and parents manage tuckshop spending.</li>
                                                                                        <li><strong>Dispute Resolution:</strong> Facilitates quick resolution of any recharge-related queries.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingAdminTuckshopPaymentHistory">
                                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdminTuckshopPaymentHistory" aria-expanded="false" aria-controls="collapseAdminTuckshopPaymentHistory">
                                                                        How to View Admin Tuckshop Payment History
                                                                    </button>
                                                                </h2>
                                                                <div id="collapseAdminTuckshopPaymentHistory" class="accordion-collapse collapse" aria-labelledby="headingAdminTuckshopPaymentHistory" data-bs-parent="#bursaryManagementAccordion">
                                                                    <div class="accordion-body">
                                                                        <div id="admin_tuckshop_payment_history">
                                                                            <p>The "Admin Tuckshop Payment History" feature provides administrators and bursary staff with a comprehensive overview of all funds added to student tuckshop accounts across the entire school. This centralized view is crucial for financial auditing, reconciliation, and monitoring the overall flow of funds into the tuckshop system. It offers a detailed log of every recharge transaction.</p>
                                                                            <ol>
                                                                                <li><strong>Navigate to the Admin Tuckshop Payment History Page:</strong>
                                                                                    <ul>
                                                                                        <li>From the sidebar menu, go to <strong>Bursary > Admin Tuckshop Payment History</strong>.</li>
                                                                                        <li>This will take you to the Admin Tuckshop Payment History page, which displays a list of all tuckshop recharges.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Review All Recharge Records:</strong>
                                                                                    <ul>
                                                                                        <li>On the Admin Tuckshop Payment History page, you will see a chronological list of all funds added to student accounts. Each entry typically includes:
                                                                                            <ul>
                                                                                                <li><strong>Transaction ID:</strong> Unique identifier for the recharge.</li>
                                                                                                <li><strong>Student ID:</strong> The ID of the student whose account was recharged.</li>
                                                                                                <li><strong>Student Name:</strong> The name of the student.</li>
                                                                                                <li><strong>Amount:</strong> The amount recharged.</li>
                                                                                                <li><strong>Date:</strong> Date and time of the recharge.</li>
                                                                                                <li><strong>Processed By:</strong> The staff member who processed the recharge.</li>
                                                                                        ...
                                                                                        <li><strong>Benefit for Users:</strong> This feature provides a complete audit trail for all tuckshop recharges, enabling administrators to ensure financial accuracy and accountability.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Filter and Search Recharges (Optional):</strong>
                                                                                    <ul>
                                                                                        <li>You can typically filter recharges by student name, ID, date range, or staff member to quickly find specific transactions.</li>
                                                                                        <li><strong>Tip for Users:</strong> Use these filters to efficiently locate specific recharge records when resolving queries or preparing financial reports.</li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li><strong>Benefits of this Feature:</strong>
                                                                                    <ul>
                                                                                        <li><strong>Centralized Monitoring:</strong> Provides a single view of all tuckshop recharges across the school.</li>
                                                                                        <li><strong>Financial Auditing:</strong> Essential for verifying financial records and ensuring compliance.</li>
                                                                                        <li><strong>Accountability:</strong> Tracks who processed each recharge, enhancing internal controls.</li>
                                                                                        <li><strong>Data Analysis:</strong> Offers insights into tuckshop funding patterns and usage.</li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ol>
                                                                        </div>
                                                            ...
                                                            <div class="accordion" id="generalAdministrationAccordion">
                                                                    ...
                                                                    <div id="collapseSystemSettings" class="accordion-collapse collapse" aria-labelledby="headingSystemSettings" data-bs-parent="#generalAdministrationAccordion">
                                                                        <div class="accordion-body">
                                                                            <div id="system_settings">
                                                                                <p>The "System Settings" feature is a critical administrative module that allows Superusers and Administrators to configure and customize various system-wide parameters of the Edupack application. This includes general application settings, academic year configurations, security parameters, and other crucial administrative controls. Proper configuration ensures the system operates according to the school's policies and academic structure, providing a tailored and efficient user experience.</p>
                                                                                <ol>
                                                                                    ...
                                                                                    <li><strong>Benefits of this Feature:</strong>
                                                                                        <ul>
                                                                                            <li><strong>Customization:</strong> Allows the school to tailor the Edupack system to its unique academic structure and policies.</li>
                                                                ...
                                                                <div class="accordion-item">
                                                                    ...
                                                                    <div id="collapseUserControl" class="accordion-collapse collapse" aria-labelledby="headingUserControl" data-bs-parent="#generalAdministrationAccordion">
                                                                        <div class="accordion-body">
                                                                            <div id="user_control">
                                                                                <p>The "User Control" feature is a powerful administrative module that allows Administrators to manage all user accounts and their associated roles within the Edupack system. This includes creating new user accounts, assigning specific roles (such as Teacher, Admission Officer, Bursary Staff, or Tuck Shop officer) and modifying existing user details. Robust user control ensures system security, proper access levels, and accountability for all actions performed within the platform.</p>
                                                                                <ol>
                                                                    ...
                                                                    <div id="collapseDiscussionThreadsManagement" class="accordion-collapse collapse" aria-labelledby="headingDiscussionThreadsManagement" data-bs-parent="#generalAdministrationAccordion">
                                                                        <div class="accordion-body">
                                                                            <div id="view_threads">
                                                                                ...
                                                                                <p>The "View Discussion Threads" feature provides a centralized platform for users to browse and access all active discussion forums or threads within the Edupack system. This is essential for fostering communication, collaboration, and knowledge sharing among students, teachers, and administrators. It allows users to stay updated on ongoing discussions and participate in relevant conversations.</p>
                                                                                <ol>
                                                                            ...
                                                                            <div id="read_message">
                                                                                ...
                                                                                <p>The "Read Message in a Thread" feature allows users to access and review the full content of any discussion thread within the Edupack system. This is crucial for following conversations, understanding context, and preparing to contribute to ongoing discussions. It provides a clear view of all posts and replies within a specific topic.</p>
                                                                                <ol>
                                                                                    <li><strong>Navigate to the View Discussion Threads Page:</strong>
                                                                                        <ul>
                                                                                            <li>From the sidebar menu, go to <strong>Administrator > Discussion Threads > Threads</strong>.</li>
                                                                            ...
                                                                            <div id="delete_thread">
                                                                                ...
                                                                                <p>The "Delete Discussion Thread" feature allows authorized users (typically the thread creator or administrators) to permanently remove an entire discussion thread from the Edupack system. This action should be performed with extreme caution, as it is usually irreversible and will remove all associated messages and replies. It's generally used for removing irrelevant, inappropriate, or outdated discussions.</p>
                                                                                <ol>
                                                                                    <li><strong>Access the Discussion Thread:</strong>
                                                                                        <ul>
                                                                                    ...
                                                                                    <li><strong>Confirm and Execute Deletion:</strong>
                                                                                        <ul>
                                                                                            ...
                                                                                            <li><strong>Warning:</strong> Once confirmed, the entire discussion thread, including all its messages and replies, will be permanently removed from the Edupack database. Ensure you have any necessary approvals or backups before performing this action.</li>
                                                                                        </ul>
                                                                                    </li>
                                                                    ...
                                                                    <div id="collapseParentManagement" class="accordion-collapse collapse" aria-labelledby="headingParentManagement" data-bs-parent="#generalAdministrationAccordion">
                                                                        <div class="accordion-body">
                                                                            <div id="register_parents">
                                                                                ...
                                                                                <p>The "Register Parents" feature allows administrators or authorized staff to create new user accounts for parents within the Edupack system. This is a crucial step for enabling parent access to student information (like results and bursary), facilitating communication, and allowing them to participate in the school community. Each parent account is a gateway for them to stay informed and engaged.</p>
                                                                                <ol>
                                                                            ...
                                                                            <div id="delete_parents">
                                                                                ...
                                                                                <p>The "Delete Parents" feature allows authorized administrators to permanently remove parent accounts from the Edupack system. This action should be performed with extreme caution, as it is usually irreversible and will remove the parent's access and potentially their historical communication records. It's typically used when a parent no longer has children enrolled in the school or in cases of data cleanup.</p>
                                                                                <ol>
                                                                                ...
                                                                                <ol>
                                                                                    ...
                                                                                    <li><strong>Confirm and Execute Unassignment:</strong>
                                                                                        <ul>
                                                                                            ...
                                                                                            <li><strong>Warning:</strong> Once confirmed, the link between the student and parent will be broken, and the parent will no longer have access to that student's information through their Edupack account.</li>
                                                                                        </ul>
                                                                                    </li>
                                                                                    <li><strong>Benefits of this Feature:</strong>
                                                                                        <ul>
                                                                    ...
                                                                    <div id="collapseProfileMessagingManagement" class="accordion-collapse collapse" aria-labelledby="headingProfileMessagingManagement" data-bs-parent="#generalAdministrationAccordion">
                                                                        <div class="accordion-body">
                                                                            <div id="profile_page">
                                                                                ...
                                                                                <p>The "Profile Page" feature provides each user (students, teachers, administrators, and parents) with a personalized section to view and manage their personal information, update security settings, and access account-specific functionalities. It serves as a central hub for individual user data and preferences within the Edupack system.</p>
                                                                                <ol>
                                                                                ...
                                                                                <ol>
                                                                                    ...
                                                                                    <li><strong>Send the Message:</strong>
                                                                                        <ul>
                                                                                            ...
                                                                                            <li>The system will then deliver your message to the recipient(s)' Edupack inbox.</li>
                                                                                    ...
                                                                                    <li><strong>Benefits of this Feature:</strong>
                                                                                        <ul>
                                                                                            ...
                                                                                            <li><strong>Security and Privacy:</strong> Keeps sensitive communications within the secure Edupack environment.</li>
                                                                            ...
                                                                            <div id="sent_messages">
                                                                                ...
                                                                                <p>The "Sent Messages" feature provides users with a record of all internal messages they have composed and sent to other users within the Edupack system. This acts as a personal outbox, allowing users to review past communications, confirm delivery, or retrieve information they have previously shared. It's an important tool for maintaining a complete communication history.</p>
                                                                                <ol>
