            ...
            <div class="col-md-12">
              <div class="card card-round">
               ...
               ORDER BY s.name ASC";
                      ...
                      $tuckshop_stmt->bind_param("ss", $selected_student['id'], $selected_student['name']);
                      ...
                      $fee_status = getStudentFeeStatus($conn, $selected_student['id'], $current_session, $current_term);
                      ...
                      $previous_outstanding_balances = getPreviousOutstandingBalances($conn, $selected_student['id'], $current_session, $current_term);
                              ...
                              <div class="row align-items-center">
                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                  <div class="numbers">
                                    ...
                                    <h4 class="card-title">₦
                                      <?php echo (isset($tuckshop_balance) && is_numeric($tuckshop_balance) ? number_format((float) $tuckshop_balance, 2, '.', ',') : '0.00'); ?>
                                    </h4>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div class="row g-3 justify-content-center">
                        <div class="col-md-7 text-center">
                          <p>Would you like to pay to your ward's school fees or Recharge tuckshop balance?</p>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#payButton').on('click', function() {
        const selectedStudentId = $('#student_id').val();
        // You can redirect or perform other actions here
        window.location.href = "parent_payment.php?student_id=" + selectedStudentId;
      });
    });
  </script>
