                  ...
                  <div class="mb-4 mt-2">
                    ...
                    <form id="attendanceForm" method="get">
                      <div class="row g-3 mb-3">
                        <div class="col-md-4">
                          <select class="form-control form-select" id="class" name="class" onchange="this.form.submit()">
                        ...
                        <div class="col-md-4">
                          <select class="form-control form-select" id="arm" name="arm" onchange="this.form.submit()">
                            <option value="" selectedn disabled>All Arms</option>
