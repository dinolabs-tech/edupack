                        ...
                        <div class="numbers">
                          <p class="card-category">Current Term</p>
                            ...
                            <form action="" method="POST">
                                  ...
                                  <br>
                                <input class="btn btn-warning" type="submit" name="term_submit" value="Update Term">
                            </form>
                              <br>
                            <h5 style="text-align:center;">Current Term:  <?php echo htmlspecialchars($current_term, ENT_QUOTES, 'UTF-8'); ?></h5>
                    ...
                    <div class="row align-items-center">
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <form action="" method="POST">
                        <input class="form-control" type="text" id="csession" name="csession" placeholder="Current Session (XXXX/XXXX)" value="<?php echo htmlspecialchars($current_session, ENT_QUOTES, 'UTF-8'); ?>" required>
                        <br>
                        <input class="btn btn-success" type="submit" name="currentsession_submit" value="Update Current Session">
                    </form>
                    <br />
                    ...
                    <div class="row align-items-center">
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <form action="" method="POST">
                        <input class="form-control" type="date" id="nextterm" name="nextterm" placeholder="Next Term Begins" value="<?php echo htmlspecialchars($next_term, ENT_QUOTES, 'UTF-8'); ?>" required>
                        <br>
                        <input class="btn btn-success" type="submit" name="nextterm_submit" value="Update Next Term">
                    </form>
                    <br />
                                ...
                                <?php foreach ($arms as $arm): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="?delete=true&table=arm&id=<?php echo htmlspecialchars($arm['id'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-danger"><span class="btn-label">
                                ...
                                <?php foreach ($classes as $class): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="?delete=true&table=class&id=<?php echo htmlspecialchars($class['id'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-danger"><span class="btn-label">
                                            <i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
