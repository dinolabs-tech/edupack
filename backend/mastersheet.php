...
function generatePDF($class, $arm, $term, $session, $students, $subjects, $scores)
{
    ...
    $pdf->Cell(0, 7, 'DINOLABS ACADEMY', 0, 1, 'C');
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(0, 7, '123 Education Way, Learning City, ED 45678', 0, 1, 'C');
    $pdf->Cell(0, 7, 'Email: info@dinolabsacademy.edu | Tel: +234 800 123 4567', 0, 1, 'C');
