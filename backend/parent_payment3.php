...
<head>
    <meta charset="UTF-8">
    <title>Parent Payment Portal</title>
...
<body>
    <div class="container mt-4">
        <h2>Parent Payment Portal for <?php echo htmlspecialchars($student_name); ?> (ID: <?php echo htmlspecialchars($student_id); ?>)</h2>
        ...
        <div class="row">
            ...
            <!-- Tuckshop Recharge Section -->
            <div class="col-md-6">
                <div class="payment-section">
                    <h4>Tuckshop Balance Recharge</h4>
        ...
        <div class="mt-4 text-center">
            <a href="bursary_dashboard.php" class="btn btn-secondary">Back to Dashboard</a>
        </div>
    </div>
