                            ...
                            <div class="card card-round">
                                ...
                                <div class="card-body pb-0">
                                    <div class="mb-4 mt-2">
                                        ...
                                        <form method="POST">
                                            <input type="hidden" name="action" value="add_fee_definition">
                                            <div class="row mb-3 g-3">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="arm" id="arm" class="form-control form-select" required>
                                            ...
                                            <div class="row mb-3 g-3">
                                                <div class="col-md-4">
                                                    <input type="text" name="service" id="service" class="form-control " placeholder="Service/Fee Name" required>
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="number" name="price" id="price" class="form-control" step="0.01" placeholder="Price" required>
                                                </div>
                                                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-round">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">Manage Fees Definitions </div>
                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped" id="basic-datatables">
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="d-flex">
                                                                        <button type="button" class="btn btn-sm btn-warning edit-fee-btn mt-5 me-3"
                                                                            ...
                                                                            data-arm="<?php echo htmlspecialchars($fee['arm']); ?>"
                                                                            data-term="<?php echo htmlspecialchars($fee['term']); ?>"
                                                                            data-service="<?php echo htmlspecialchars($fee['service']); ?>"
                                                                            data-price="<?php echo htmlspecialchars($fee['price']); ?>"
                                                                            data-hostel="<?php echo htmlspecialchars($fee['hostel']); ?>"
                                                                            data-session="<?php echo htmlspecialchars($fee['session']); ?>">
                                                        ...
                                                        <?php else: ?>
                                                            <tr>
                                                                <td colspan="9">No fee definitions found.</td>
                                                            </tr>
                                                        <?php endif; ?>
                                                    </tbody>
                                                </table>
