                          ...
                          while ($rowdel = $sqdel->fetch_assoc()) {
                            ...
                            <tr>
                              ...
                              <td class="text-center d-flex">
                                <a class="btn btn-warning edit-btn btn-icon btn-round ps-2 me-3"
                                  data-id="<?= $q_idt ?>"
                                ...
                                <a class="btn btn-danger btn-icon btn-round ps-1" href="quedel.php?delid=<?= $q_idt ?>"><span class="btn-label">
                      ...
                      <div class="card-body">
                        <form id="editForm" method="POST" action="">
                          ...
                          <div class="d-flex gap-2">
                            <button type="submit" name="update_question" class="btn btn-success btn-icon btn-round ps-1"><span class="btn-label">
                                <i class="fa fa-sync-alt"></i></button>
                            <button type="button" id="cancelEdit" class="btn btn-secondary btn-icon btn-round ps-1"> <span class="btn-label">
