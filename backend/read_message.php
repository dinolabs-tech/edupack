          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-footer">
                ...
                <button type="button" class="btn btn-primary btn-icon btn-round ps-1" data-toggle="modal" data-target="#replyModal">
      ...
      <form action="reply_message.php" method="post" novalidate>
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary btn-icon btn-round ps-1" data-dismiss="modal"><i class="fas fa-tiimes"></i></button>
            <button type="submit" class="btn btn-success btn-icon btn-round ps-1"><i class="fab fa-telegram-plane"></i></button>
          </div>
        </div>
      </form>
    </div>
