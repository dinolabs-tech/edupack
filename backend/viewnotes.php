            ...
            <div class="col-md-12">
                <div class="card">
                  ...
                  <table class="basic-datatables">
                          ...
                          <tbody>
                              <?php if (!empty($notes_files)): ?>
                                  <?php foreach ($notes_files as $file): ?>
                                      <tr>
                                          <td><?php echo htmlspecialchars($file); ?></td>
                                          <td><a href="<?php echo $notes_dir . $file; ?>" download class="btn btn-warning btn-icon btn-round ps-1"><span class="btn-label">
                                          <i class="fa fa-cloud-download-alt"></i></a></td>
                                      </tr>
                                  <?php endforeach; ?>
                              <?php else: ?>
                                  <tr>
                                      <td colspan="2" class="no-assignments">Notes not found for your class.</td>
                                  </tr>
                              <?php endif; ?>
                          </tbody>
                      </table>
