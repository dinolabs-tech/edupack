                  ...
                  <div class="mb-4 mt-2">
                    ...
                    <form method="POST" class="p-3 border rounded bg-white" id="studentForm">
                      <div class="row g-2">
                        ...
                        <div class="col-md-6">
                          <input type="text" name="studentname" id="name" readonly class="form-control" placeholder="Student Name" value="<?= isset($student) ? $student['studentname'] : '' ?>" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <input type="text" name="studentclass" id="class" readonly class="form-control" placeholder="Class" value="<?= isset($student) ? $student['studentclass'] : '' ?>" required>
                        </div>
                        <div class="col-md-4">
                          <input type="text" name="csession" id="session" readonly class="form-control" placeholder="Session" value="<?= isset($student) ? $student['csession'] : '' ?>">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12 d-flex me-auto">
                          <button type="submit" name="submit" class="btn btn-success btn-icon btn-round"><span class="fas fa-save"></span> </button> &nbsp;

                          <button type="reset" class="btn btn-secondary btn-icon btn-round ps-1"> <span class="btn-label">
                        ...
                        <tbody>
                          <?php while ($row = $students->fetch_assoc()): ?>
                            <tr>
                              ...
                              <td><?= $row['vbalance'] ?></td>
                              <td class="d-flex">
                                <a href="?regno=<?= $row['regno'] ?>" class="btn btn-warning btn-icon btn-round ps-2 me-2"><span class="btn-label">
                                    <i class="fa fa-edit"></i></a>
                                <a href="?delete_id=<?= $row['regno'] ?>" class="btn btn-danger btn-icon btn-round ps-1 me-2" onclick="return confirm('Are you sure you want to delete this student?')"><span class="btn-label">
                                    <i class="fa fa-trash"></i></a>
                                <button type="button" class="btn btn-success btn-icon btn-round ps-1" data-bs-toggle="modal" data-bs-target="#topupModal" data-regno="<?= $row['regno'] ?>" data-studentname="<?= $row['studentname'] ?>"><span class="btn-label">
