                  ...
                  <div class="mb-4 mt-2">
                    ...
                    ?>
                        ...
                        <form method="post" action="">
                          ...
                          <button type="submit" class="btn btn-success btn-icon btn-round"><span class="fas fa-save"></span></button>
                          <a href="settime.php" class="btn btn-secondary btn-icon btn-round"><span class="fas fa-times"></span></a>
                        </form>
                      <?php
                      } else {
                      }
                      ...
                      <form method="post" action="" class="row g-1">
                        ...
                        <div class="col-md-2">
                          <select class="form-select form-control" id="arm" name="arm" required>
                            <option value="" selected disabled>Select Arm</option>
                            <?= $arm_options ?>
                          </select>
                        </div>
                        <div class="col-md-2">
                          <select class="form-select form-control" id="term" name="term" required>
                        ...
                        if ($result && $result->num_rows > 0) {
                          while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                              ...
                              <td><?= htmlspecialchars($row['testtime']) ?></td>
                              <td>
                                <a href='?edit=<?= $row['id'] ?>' class='btn btn-warning btn-icon btn-round ps-1 me-2'><span class="fas fa-edit"></span></a>
                                <form style='display:inline;' method='post' action='' onsubmit="return confirm('Are you sure you want to delete this record?');">
                                  <input type='hidden' name='action' value='delete'>
                                  <input type='hidden' name='id' value='<?= $row['id'] ?>'>
                                  <button type='submit' class='btn btn-danger btn-icon btn-round'><span class="fas fa-trash"></span></button>
                                </form>
                              </td>
                            </tr>
                        <?php  }
