                          ...
                          <?php if (!empty($students)): ?>
                            <?php foreach ($students as $student): ?>
                              <tr>
                                ...
                                <td class="d-flex">
                                  <a href="javascript:void(0);" onclick="editProduct(<?php echo htmlspecialchars(json_encode($student)); ?>)" class="me-2 btn btn-warning btn-icon btn-round ps-2"><span class="btn-label">
                                      <i class="fa fa-edit"></i></a>
                                  <a class="btn btn-danger btn-icon btn-round ps-1" href="?delete=<?php echo $student['productid']; ?>" onclick="return confirm('Are you sure you want to delete this product?');"><span class="btn-label">
