...
if (isset($_POST['expirydate_submit'])) {
  // Get the value from the form
  $nextterm_raw = $_POST['expirydate'];
  ...
  $stmt = $conn->prepare("UPDATE sub SET expdate = ? WHERE id = 1");
          ...
          <div
            ...
            <div>
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="deploy.php">Deploy Now</a></li>
              </ol>
            </div>
              ...
              <div class="card card-stats card-danger card-round">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col col-stats ms-3 ms-sm-0">
                      <div class="numbers">
                        <p class="card-category">Set Expiry Date</p>
