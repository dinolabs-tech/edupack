      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="privacy-header" data-aos="fade-up">
          <div class="header-content">
            ...
            <p>This Privacy Policy describes how EduPack collects, uses, and discloses your information when you use our services.</p>
          </div>
        </div>
        ...
        <h1 class="mb-4">Privacy Policy</h1>
            ...
            <p>EduPack uses the collected data for various purposes:</p>
            <ul>
                <li>To provide and maintain our services.</li>
                <li>To process your applications and manage admissions.</li>
                <li>To communicate with you, including sending alerts, conference invitations, and application updates.</li>
            ...
            <ul>
                ...
                <li>Protect and defend the rights or property of EduPack.</li>
            ...
            If you have any questions about this Privacy Policy, please contact us via the contact form on our website.</p>
